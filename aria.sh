...
aria2c --enable-rpc --rpc-listen-all=true --rpc-listen-port 6800 --check-certificate=false \
   --max-connection-per-server=10 --rpc-max-request-size=1024M \
   --listen-port=51413 --bt-max-peers=0 --seed-time=0.01 --bt-force-encryption=true --bt-request-peer-speed-limit=0 --bt-tracker-connect-timeout=600 --bt-stop-timeout=600 \
   --follow-torrent=mem --peer-id-prefix=-qB4350- --user-agent=qBittorrent/4.3.5 --peer-agent=qBittorrent/4.3.5 \
